...
%cup
%class scanner // nombre de la clase que se va a crear aquí 
...
<CADENA> {
    ...
    {INICIO_FIN_CADENA} {String tmp = cadena+"\""; yybegin{YYINITIAL}; return new Symbol (sym.CADENA, yychar, yyline, tmp);}
